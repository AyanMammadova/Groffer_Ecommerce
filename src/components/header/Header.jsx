...
function Header() {
    ...
    return (
        <>
            <div className='flex font-space-grotesk justify-between p-[10px] md:pl-[40px] md:pr-[70px] items-center'>
                <div className='flex items-center  gap-[30px]'>
                    ...
                    <div className='hidden md:block'>
                        <div className='bg-[#F2F2F2]  relative  flex items-center rounded-sm'>
                            ...
                            <div className={` ${searchedValue.length > 0 ? 'absolute' : 'hidden'}  p-[10px] top-[60px] overflow-y-hidden  h-[300px] w-[100%] bg-white shadow-lg mt-[10px] border-[1px] border-gray-100`}>
                                {
                ...
                <div className='flex gap-[20px] items-center'>
                    <div className='md:flex hidden '>
                        <div className='relative group bg-green-300 cursor-pointer'>
                            ...
                            <div className='absolute top-[20px] bg-white px-[20px] -right-[20px] z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 p-2 rounded-md shadow-xl'>
                                <p>My Account</p>
                                <p>Login|Register</p>
                            </div>
                        </div>
