    ...
    return (
        <>
            <form onSubmit={handleSubmit} className={`flex flex-col gap-[20px] py-[10px]`}>
                ...
                {focusedField === 'username' && errors.username && <p className='text-red-500 font-[500] mx-[5%] text-[.8em] -mt-[10px]'>{errors.username}</p>}
                ...
                {focusedField === 'firstname' && errors.firstname && <p className='text-red-500 font-[500] mx-[5%] text-[.8em] -mt-[10px]'>{errors.firstname}</p>}
                ...
                {focusedField === 'lastname' && errors.lastname && <p className='text-red-500 font-[500] mx-[5%] text-[.8em] -mt-[10px]'>{errors.lastname}</p>}
