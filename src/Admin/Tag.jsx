    ...
    <>
      ...
      <table className='w-[96%]  mx-auto border-2 border-black mt-[30px]'>
        <thead>
          ...
          <th className='py-[10px] border-2 border-black'>Tag</th>
          <th className='py-[10px] border-2 border-black'>TagId</th>
        ...
        <tbody>
          {
            Array(10).fill('ayan').map((item, i) => {
              return <tr>
                ...
                <td className='py-[10px] border-2 px-[10px] border-black font-[500]'>Baking</td>
                <td className='py-[10px] border-2 px-[10px] border-black font-[500]'>{i + 6}</td>
